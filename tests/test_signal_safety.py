"""Signal-safety tests for ReadBuffer and MessageDecoder (BaseException injection)."""
...
# ---- merged from test_buffer_signal_safety.py ----
...
# ---- merged from test_codec_signal_safety.py ----
